...
cp "$repo_dir/docs/screenshots/"{library-mac,home-iphone,extension-iphone,connection-mac,archive-mac,archive-iphone,persona}.png "$stage_dir/docs/screenshots/"
