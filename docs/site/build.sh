...
cp "$repo_dir/docs/screenshots/"{library-mac,connection-mac,server-mac,home-iphone,connection-iphone,share-iphone,extension-iphone}.png "$stage_dir/docs/screenshots/"
